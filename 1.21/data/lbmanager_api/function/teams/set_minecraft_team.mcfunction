...
execute if score success lbmanager.main matches 0 run return run function lbmanager:commands/exceptions/exception {level:"error",log:"minecraft_team_not_exist"}
