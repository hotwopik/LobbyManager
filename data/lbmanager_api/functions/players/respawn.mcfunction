...
data modify storage lbmanager:temp data.after_task set value ""

execute store success score success lbmanager.main run function lbmanager:commands/own_spawn_check with storage lbmanager:temp data
