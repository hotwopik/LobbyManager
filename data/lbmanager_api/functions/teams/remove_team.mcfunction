...
$execute unless data storage lbmanager:main teams."$(id)" run function lbmanager:teams/exceptions/team_notexist
...
$data remove storage lbmanager:main team_ids[{id:"$(id)"}]
