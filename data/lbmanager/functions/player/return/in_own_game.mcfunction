...
execute if entity @s[tag=!lbmanager.in_team] if data storage lbmanager:main watching_point run function lbmanager:player/return/transfer with storage lbmanager:main watching_point
